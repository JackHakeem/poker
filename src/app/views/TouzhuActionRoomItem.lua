...
local TouzhuActionRoomItem = class("TouzhuActionRoomItem", function(...)
	return display.newNode()
end)


function TouzhuActionRoomItem:ctor(control)
	self.control_ = control 
	local node, width, height = cc.uiloader:load("touzhu_aciton_room_item.json")
	self:addChild(node)
	self.root_ = node
...
function TouzhuActionRoomItem:getCoins()
	return self.mCoinsNum
end

function TouzhuActionRoomItem:setNum(num)
